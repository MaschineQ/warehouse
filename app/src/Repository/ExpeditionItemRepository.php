...
class ExpeditionItemRepository extends ServiceEntityRepository
{
    ...
    public function add(ExpeditionItem $entity, bool $flush = false): void
    {
...
//    /**
//     * @return ExpeditionItem[] Returns an array of ExpeditionItem objects
//     */
...
//    public function findOneBySomeField($value): ?ExpeditionItem
//    {
//        return $this->createQueryBuilder('e')
//            ->andWhere('e.exampleField = :val')
//            ->setParameter('val', $value)
